...
Thanks for using `wickra-xray`. Here is where to go for help.
...
- Open a [GitHub Discussion](https://github.com/wickra-lib/wickra-xray/discussions)
  for questions and ideas.

## Bugs and feature requests

Open a [GitHub issue](https://github.com/wickra-lib/wickra-xray/issues) using
...
`wickra-xray` is a research and engineering tool: it evaluates conditions
