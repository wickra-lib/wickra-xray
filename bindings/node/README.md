...
**A free explorer that shows, historically, what only Wickra computes — for Node.js. `npm install wickra-xray` — prebuilt native binary, no system dependencies.**
...
- **Runnable example:** [`examples/node/`](https://github.com/wickra-lib/wickra-xray/tree/main/examples/node)
